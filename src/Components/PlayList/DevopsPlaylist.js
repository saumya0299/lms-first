...
function DevopsPlayList({ userRole }) {
...
<div class="row">
   ...
   <div class="column">
      ...
      <div class="details">
         <h3>complete devops tutorial</h3>
...
<div class="box-container">
   ...
   <button class="box" onClick={() => goToWatchVideo()}>
      ...
      <img src={devops} alt=""/>
      <h3>complete Devops tutorial (part 01)</h3>
   </button>

   <a class="box" href="watch-video.html">
      <i class="fas fa-play"></i>
      <img src={devops} alt="" />
      <h3>complete Devops tutorial (part 02)</h3>
   </a>

   <a class="box" href="watch-video.html">
      <i class="fas fa-play"></i>
      <img src={devops} alt="" />
      <h3>complete Devops tutorial (part 03)</h3>
   </a>

   <a class="box" href="watch-video.html">
      <i class="fas fa-play"></i>
      <img src={devops} alt="" />
      <h3>complete Devops tutorial (part 04)</h3>
   </a>

   <a class="box" href="watch-video.html">
      <i class="fas fa-play"></i>
      <img src={devops} alt="" />
      <h3>complete Devops tutorial (part 05)</h3>
   </a>

   <a class="box" href="watch-video.html">
      <i class="fas fa-play"></i>
      <img src={devops} alt=""/>
      <h3>complete devops tutorial (part 06)</h3>
   </a>
